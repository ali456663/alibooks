...
check("Release gate checks accountant handoff", releaseGate.includes('"check:handoff"'), "Release gate should run accountant handoff check");
...
check("Docs include accountant handoff", docs.includes("npm run check:handoff") && docs.includes("redovisningspaket"), "Docs should expose accountant handoff rules");
