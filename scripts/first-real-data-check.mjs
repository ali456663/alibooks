...
check("Frontend blocks first real data without backup restore proof", includesAll(mainSource, ["key: \"backup-restore\"", "backupValidation?.ok && archivePackageWarnings === 0 ? \"ok\" : \"critical\"", "Riktig data ska inte borja utan verifierad backup"]), "The real-data gate must fail closed until backup and restore proof is verified.");
