...
check("Frontend blocks real bookkeeping while minor-unit support is missing", includesAll(mainSource, ["key: \"money-support\"", "minorUnitSupport ? \"ok\" : \"critical\"", "statusLabel: minorUnitSupport ? \"OK\" : (language === \"sv\" ? \"Stoppar\"", "avskild testdata", "riktiga bokforingsposter"]), "Daily readiness must block real bookkeeping while still allowing isolated test data without minor-unit support.");
