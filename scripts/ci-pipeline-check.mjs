...
check("Backend CI uses Java 21", includesAll(ci, ["actions/setup-java@v6", 'java-version: "21"']), "Backend CI should match the Spring Boot Java 21 build with the supported setup-java action.");
