...
- `npm run check:use-today`: 32/32, slutligt lokalt anvandningsbeslut med synlig Startklar-knapp, stoppsignaler, vit-sida/render recovery, Startklar-UI och produktionsblockerare.
